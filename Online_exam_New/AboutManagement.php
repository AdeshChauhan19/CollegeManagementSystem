...
<html>
    <head>
        ...
        <title>This project is devolped by Adesh, Anugrah & Aryan</title>
    </head>
    <body>
        <div class="panel panel-default">
			...
			<div class="container">
				<p style="text-align:center;">CollegeManagementSystem.</p>
                        </div><br><br>
                        
                        <h1><strong>Project title: </strong>College Management System</h1>
                        <h1><strong>Made by: </strong>Team AAA</h1>
                        <h1><strong>College: </strong>GLA University</h1>
